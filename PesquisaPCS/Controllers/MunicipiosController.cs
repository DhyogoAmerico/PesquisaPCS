...
namespace PesquisaPCS.Controllers
{
    public class MunicipiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idmunicipio,Nome_municipio")] Municipio municipio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idmunicipio,Nome_municipio")] Municipio municipio)
        {
